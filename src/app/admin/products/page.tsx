          ...
          <>
            ...
            >
               <div className="p-8 border-b border-white/10 flex justify-between items-center bg-white/5">
                  <h2 id="product-form-title" className="text-2xl font-black text-white">{editingProduct ? 'Sửa dự án' : 'Thêm dự án mới'}</h2>
                   <button aria-label="Đóng biểu mẫu sản phẩm" onClick={() => setIsModalOpen(false)} className="p-2 hover:bg-white/10 rounded-full text-slate-400"><X size={24} /></button>
               </div>
               ...
               <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-10 space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      ...
                      <div className="space-y-2">
                        <label htmlFor="product-name" className="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Tên dự án</label>
                        <input 
                      ...
                      {/* Author */}
                      <div className="space-y-2">
                        <label htmlFor="product-author" className="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Tác giả</label>
                        <input 
                          id="product-author" type="text" required
                      ...
                      {/* Career Path */}
                      <div className="space-y-2">
                        <label htmlFor="product-career-path" className="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Phân loại sản phẩm</label>
                        <select 
                          id="product-career-path" value={formData.CareerPath} onChange={e => setFormData({...formData, CareerPath: e.target.value})}
                      ...
                      {/* Year */}
                      <div className="space-y-2">
                        <label htmlFor="product-year" className="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Năm dự án</label>
                        <input 
                          id="product-year" type="number" required
                  ...
                  {/* Description */}
                  <div className="space-y-2">
                    <label htmlFor="product-description" className="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Mô tả dự án</label>
                    <textarea 
                      id="product-description" rows={3} required
                  ...
                  {/* Tech Tags */}
                  <div className="space-y-2">
                    <label htmlFor="product-tech-tags" className="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Công nghệ (Cách nhau bằng dấu phẩy)</label>
                    <input 
                      id="product-tech-tags" type="text" required
                  ...
                  {/* App URL */}
                  <div className="space-y-2">
                    <label htmlFor="product-app-url" className="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">URL Ứng dụng / Demo</label>
                    <input 
                      id="product-app-url" type="url" required
                  ...
                  <div className="space-y-4">
                    <label htmlFor="product-image-url" className="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Hình ảnh dự án</label>
                    <div className="flex flex-col md:flex-row gap-6">
                       ...
                       <div className="flex-1 space-y-2">
                          ...
                          <input 
                            id="product-image-url" type="text" required readOnly
